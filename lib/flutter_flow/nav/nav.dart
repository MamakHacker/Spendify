...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'mainInterface',
          path: '/mainInterface',
          builder: (context, params) => MainInterfaceWidget(),
        ),
        FFRoute(
          name: 'supportPage',
          path: '/supportPage',
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'termsOfServices')
        ...
        FFRoute(
          ...
          path: '/analyticsPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'analyticsPage')
              : AnalyticsPageWidget(),
        ),
        FFRoute(
          name: 'createBudget',
          path: '/createBudget',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'createBudget')
              : CreateBudgetWidget(),
        ),
        FFRoute(
          name: 'successbudget',
          path: '/successbudget',
          builder: (context, params) => SuccessbudgetWidget(),
        ),
        FFRoute(
          name: 'authentication',
          path: '/authentication',
        ...
        FFRoute(
          name: 'faqPage2',
          path: '/faqPage2',
          builder: (context, params) => FaqPage2Widget(),
        ),
        FFRoute(
          name: 'profilePage',
          path: '/profilePage',
