...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = spendifyAppV2SupabaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'termsOfServices': TermsOfServicesWidget(),
    };
            ...
            customWidget: Column(
              ...
              children: [
                Icon(
                  ...
                  color: currentIndex == 4 ? Colors.black : Color(0x00000000),
                  size: 24.0,
                ),
              ],
            ),
